...
from utils import get_device, make_dir, get_CIFAR10loader, get_idx_to_class
...
def main():
    ...
    num_classes = 10
    prefix = "CIFAR10_LeNet"
    device = get_device()
    model = LeNet_3Channel(num_classes)
    model.load_state_dict(torch.load(args.ckpt_file))
    _, _, test_loader = get_CIFAR10loader(
    ...
    dataset = datasets.CIFAR10(root=args.dataset_root, train=True)
